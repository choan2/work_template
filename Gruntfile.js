    ...
    grunt.initConfig({
        ...
        csslint: {
            docs: {
                ...
                src: '<%= config.dist %>/_ui/css/style.css'
            }
        },
        ...
        cssmin: {
            ...
            docs: {
                src: '<%= config.dist %>/_ui/css/style.css',
                dest: '<%= config.dist %>/_ui/css/style.min.css'
            }
        },
        ...
        concat: {
            docs: {
                ...
                dest: '<%= config.dist %>/_ui/js/common.js'
            }
        },
        ...
        uglify: {
            ...
            docs: {
                ...
                dest: '<%= config.dist %>/_ui/js/common.min.js'
            },
        },
        ...
        connect: {
            server: {
                options: {
                    ...
                    // keepalive: true,
                    base: '<%= config.dist %>',
                    open: 'http://<%= connect.server.options.hostname %>:<%= connect.server.options.port %>/_service/test-html/index.html'
                }
            }
        },
